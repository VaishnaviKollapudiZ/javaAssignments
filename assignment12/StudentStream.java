...
public class StudentStream {
    ...
    public static void printAllDepartments(List<Student> list)
    {
    ...
    public static List<Student> maleStudentsInCSE(List<Student> list)
    {
    ...
    public static void highestPercentage(List<Student> list)
    {
        //6.Get the details of highest student having highest percentage ?
        Optional<Student> highest=list.stream()
                .collect(Collectors.maxBy
                        (Comparator.comparing(student->student.getPerTillDate())));
        System.out.println("Name of student with highest percentage is "+(highest.isPresent()?highest.get().getName():"Not possible"));
    }

    public static void studentsInEachDepartment(List<Student> list)
    {
    ...
    public static void averagePercentage(List<Student> list) {
        ...
        for (String department : set) {
            Double avg = list.stream()
                    .filter((student -> student.getEngDepartment().equals(department)))
                    .collect(Collectors.averagingDouble(student->student.getPerTillDate()));
            System.out.println("Department : "+department + "\n"+ "Average Percentage :"+avg+"\n");
        }
    }
    public static void youngestStudentInElectronics(List<Student> list)
    {
        //9. Get the details of youngest male student in the Electronic department?
        Optional<Student> highest=list.stream().filter(student->student.getEngDepartment().equals("Electronic"))
                .collect(Collectors.minBy
                        (Comparator.comparing(student->student.getAge())));
        System.out.println("Name of student with highest percentage is "+(highest.isPresent()?highest.get().getName():"Not possible"));
    }

    public static void genderCountInCse(List<Student> list)
    {
    ...
    public static void main(String[] args){
        ...
        youngestStudentInElectronics(studentList);
